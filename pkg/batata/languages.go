...
var LangStrings = map[Language]Strings{
	...
	LangHindi: {
		...
		ConfigSaved:           "✅ कॉन्फ़िगरेशन सहेजा गया! सेटिंग्स बदलने के लिए किसी भी समय 'Batata help' कहें।",
	...
	LangPortuguese: {
		...
		ConfigSaved:           "✅ Configuração salva! Diga 'Batata help' quando quiser mudar algo.",
	...
	LangRussian: {
		...
		ConfigSaved:           "✅ Конфигурация сохранена! Скажите 'Batata help' в любой момент, чтобы изменить настройки.",
	...
	LangJapanese: {
		...
		ConfigSaved:           "✅ 設定が保存されました！設定を変更したい時はいつでも'Batata help'と言ってください。",
	...
	LangGerman: {
		...
		ConfigSaved:           "✅ Konfiguration gespeichert! Sag jederzeit 'Batata help', um Einstellungen zu ändern.",
	...
	LangFrench: {
		...
		ConfigSaved:           "✅ Configuration enregistrée ! Dites 'Batata help' à tout moment pour modifier les paramètres.",
		MenuTitle:             "🥔 Menu Batata",
	...
	LangItalian: {
		...
		ConfigSaved:           "✅ Configurazione salvata! Di' 'Batata help' in qualsiasi momento per modificare le impostazioni.",
		MenuTitle:             "🥔 Menu Batata",
	...
	LangArabic: {
		...
		ConfigSaved:           "✅ تم حفظ التكوين! قل 'Batata help' في أي وقت لتغيير الإعدادات.",
	...
	LangTurkish: {
		...
		ConfigSaved:           "✅ Yapılandırma kaydedildi! Ayarları değiştirmek için istediğiniz zaman 'Batata help' deyin.",
	...
	LangIndonesian: {
		...
		ConfigSaved:           "✅ Konfigurasi disimpan! Ucapkan 'Batata help' kapan saja untuk mengubah pengaturan.",
		MenuTitle:             "🥔 Menu Batata",
